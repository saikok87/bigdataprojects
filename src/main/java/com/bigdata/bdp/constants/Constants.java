 ...
 * 
 */
package com.bigdata.bdp.constants;
...
public interface Constants {
	...
	String HBASE_CONFIG_ZOOKEEPER_CLIENT_PORT = "bigdataqueue.config.zookeeper.client.port";
	String HBASE_ZOOKEEPER_CLIENT_PORT = "bigdataqueue.zookeeper.port";
	String HBASE_CONFIG_ZOOKEEPER_QUORUM = "bigdataqueue.config.hbase.quorum";
	String HBASE_ZOOKEEPER_SERVER = "bigdataqueue.hbase.quorum";
	...
	String bigdataqueue_LOOKUP_TABLE_NAME = "bigdataqueue.lookup.table";
	String bigdataqueue_LOOKUP_COLUMN_FAMILY="bigdataqueue.lookup.family";
	String bigdataqueue_LOOKUP_COLUMN_NAME="bigdataqueue.lookup.column";
	
	String bigdataqueue_SNAPSHOT_TABLE_NAME = "bigdataqueue.snapshot.table";
	String bigdataqueue_SNAPSHOT_COLUMN_FAMILY = "bigdataqueue.snapshot.family";
	String bigdataqueue_SNAPSHOT_COLUMN_NAME = "bigdataqueue.snapshot.column";
