...
public class HBaseM5BulkLoadDriver extends Configured implements Tool, Constants {

	private static Logger logger = Logger.getLogger(HBaseM5BulkLoadDriver.class);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(HBaseM5BulkLoadDriver.class);
		job.setMapperClass(HBaseM5BulkLoadMapper.class);
	...
	public static void main(String[] args){
		...
		HBaseM5BulkLoadDriver driver = new HBaseM5BulkLoadDriver();
		driver.init(args);
	}
	...
	private void init(String[] args) {
		...
		try {
			exit = ToolRunner.run(new HBaseM5BulkLoadDriver(), args);
